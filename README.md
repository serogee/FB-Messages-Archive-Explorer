...
![Screenshot of FB Messages Archive Explorer showing a chat conversation with message bubbles, a sidebar chat list, and a statistics panel](public/demo.png) \* Dummy data for demo purposes
